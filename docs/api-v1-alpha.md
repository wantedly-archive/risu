...
| **status** | *string* | status of build. one of "building" or "build completed and pushing" or "failed to build" or "build completed and pushed" or "failed to push" | `"succeeded"` |
